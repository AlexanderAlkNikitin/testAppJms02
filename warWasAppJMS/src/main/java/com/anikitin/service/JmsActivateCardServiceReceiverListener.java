 ...
 */
@Service
public class JmsActivateCardServiceReceiverListener implements MessageListener {

    private static final Logger LOG = LoggerFactory.getLogger(JmsActivateCardServiceReceiverListener.class);
